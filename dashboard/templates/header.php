                                                ...
                                                <li class="nav-item dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
                                                                <div class="text-center py-4">
                                                                        ...
                                                                        <div class="mb-3 small text-center text-muted"><?= $_SESSION['username'] ?>@gmail.com</div>
                                                                        <a href="../edit-profile.php" class="btn btn-outline-light btn-rounded">Manage Your Account</a>
                                                                </div>
                                                                <div class="list-group">
                                                                        <a href="../controllers/logout.php" class="list-group-item text-danger">Sign Out!</a>
                                                                </div>
                                                        </div>
                                                </li>
                                        </ul>
